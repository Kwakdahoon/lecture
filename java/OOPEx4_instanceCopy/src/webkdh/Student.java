...
public class Student { // 1
    ...
    // 생성자를 이용한 깊은 복사
    public Student(Student orginStudent) {
    	this.stuNo = orginStudent.stuNo;
    	this.name = orginStudent.name;
    	this.ko = orginStudent.ko;
    	this.eg = orginStudent.eg;
    	this.math = orginStudent.math;
    	this.tot = orginStudent.tot;
    	this.avg = orginStudent.avg;
    	this.grade = orginStudent.grade;
    }
    // 생성자
